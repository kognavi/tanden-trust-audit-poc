...
| lib/metadata-signature.js | digest helpers, raw provider dispatch helpers, signSidecarMetadata, verifySidecarMetadataSignature | Sign | sidecar metadataのdigest生成とcanonical raw-message署名・検証、legacy provider fallback | tests/metadata-signature.test.js |
