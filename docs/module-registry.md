...
| lib/pg-signing-logger.js | PgSigningLogger, GENESIS_HASH | Ledger | PostgreSQLのappend-only signing event hash chainを記録・検証し、event IDでimmutable rowを取得 | tests/pg-signing-logger.test.js |
